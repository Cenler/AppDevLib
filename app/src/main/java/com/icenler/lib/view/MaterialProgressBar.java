...
public class MaterialProgressBar extends ProgressBar {
    ...
    public MaterialProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int progressColour;
        try {
            backgroundColour = ta.getColor(R.styleable.MaterialProgressBar_backgroundColor, 0);
            progressColour = ta.getColor(R.styleable.MaterialProgressBar_progressColor, 0);
