...
/**
 * Created by iCenler - 2016/2/5.
 * Description：Material Design 风格 CheckBox
 */
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        int tickColor = ta.getColor(R.styleable.SmoothCheckBox_scb_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.SmoothCheckBox_scb_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.SmoothCheckBox_scb_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.SmoothCheckBox_scb_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.SmoothCheckBox_scb_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_scb_stroke_width, ScreenUtil.dp2px(0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = ScreenUtil.dp2px(DEF_DRAW_SIZE);
