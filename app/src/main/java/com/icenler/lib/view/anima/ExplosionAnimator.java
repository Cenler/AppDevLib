...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = ScreenUtil.dp2px(5);
    private static final float Y = ScreenUtil.dp2px(20);
    private static final float V = ScreenUtil.dp2px(2);
    private static final float W = ScreenUtil.dp2px(1);
