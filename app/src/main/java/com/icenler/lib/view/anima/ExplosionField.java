...
public class ExplosionField extends View {
    ...
    private void init() {
        Arrays.fill(mExpandInset, ScreenUtil.dp2px(32));
    }
    ...
    public void explode(final View view) {
        ...
        explode(ImageUtil.createBitmapFromView(view), r, startDelay, ExplosionAnimator.DEFAULT_DURATION);
    }
    ...
    public static ExplosionField attachToWindow(Activity activity) {
        ...
        rootView.addView(explosionField, new ViewGroup.LayoutParams(-1, ViewGroup.LayoutParams.MATCH_PARENT));
