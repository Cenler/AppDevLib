...
import com.icenler.lib.view.damp_spring.adapters.IOverScrollDecoratorAdapter;
...
public abstract class OverScrollBounceEffectDecoratorBase implements IOverScrollDecor, View.OnTouchListener {
    ...
    protected class IdleState implements IDecoratorState {
        ...
        public int getStateId() {
            return IOverScrollState.STATE_IDLE;
        }
    ...
    protected class OverScrollingState implements IDecoratorState {
        ...
        @Override
        public void handleEntryTransition(IDecoratorState fromState) {
            mCurrDragState = (mStartAttr.mDir ? IOverScrollState.STATE_DRAG_START_SIDE : IOverScrollState.STATE_DRAG_END_SIDE);
            mStateListener.onOverScrollStateChange(OverScrollBounceEffectDecoratorBase.this, fromState.getStateId(), this.getStateId());
        }
    }
    ...
    protected class BounceBackState implements IDecoratorState, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        ...
        @Override
        public int getStateId() {
            return IOverScrollState.STATE_BOUNCE_BACK;
        }
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            mUpdateListener.onOverScrollUpdate(OverScrollBounceEffectDecoratorBase.this, IOverScrollState.STATE_BOUNCE_BACK, (Float) animation.getAnimatedValue());
        }
