...
public class MultiStateViewEx extends FrameLayout {
    ...
    public MultiStateViewEx(Context context) {
        this(context, null);
    }

    public MultiStateViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MultiStateViewEx(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MultiStateViewEx);

        int loadingViewResId = a.getResourceId(R.styleable.MultiStateViewEx_msv_loadingView, 0);
        mLoadingView = mInflater.inflate(loadingViewResId, this, false);
        addView(mLoadingView, mLoadingView.getLayoutParams());

        int emptyViewResId = a.getResourceId(R.styleable.MultiStateViewEx_msv_emptyView, 0);
        ...
        int errorViewResId = a.getResourceId(R.styleable.MultiStateViewEx_msv_errorView, 0);
        ...
        int networkViewResId = a.getResourceId(R.styleable.MultiStateViewEx_msv_networkView, 0);
        ...
        int viewState = a.getInt(R.styleable.MultiStateViewEx_msv_viewState, STATE_CONTENT);
