...
/**
 * Description: LinearLayout 布局百分比适配扩展
 */
public class PercentLinearLayout extends LinearLayout {

    private static final String TAG = "PercentLinearLayout";
    private com.zhy.android.percent.support.PercentLayoutHelper mPercentLayoutHelper;

    public PercentLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        mPercentLayoutHelper = new com.zhy.android.percent.support.PercentLayoutHelper(this);
    }
