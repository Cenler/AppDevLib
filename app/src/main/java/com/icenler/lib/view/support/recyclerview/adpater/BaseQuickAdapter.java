...
package com.icenler.lib.view.support.recyclerview.adpater;
...
import com.icenler.lib.view.support.recyclerview.adpater.animation.AlphaInAnimation;
import com.icenler.lib.view.support.recyclerview.adpater.animation.BaseAnimation;
import com.icenler.lib.view.support.recyclerview.adpater.animation.ScaleInAnimation;
import com.icenler.lib.view.support.recyclerview.adpater.animation.SlideInBottomAnimation;
import com.icenler.lib.view.support.recyclerview.adpater.animation.SlideInLeftAnimation;
import com.icenler.lib.view.support.recyclerview.adpater.animation.SlideInRightAnimation;
import com.icenler.lib.view.support.recyclerview.adpater.callback.ItemDragAndSwipeCallback;
import com.icenler.lib.view.support.recyclerview.adpater.listener.OnItemDragListener;
import com.icenler.lib.view.support.recyclerview.adpater.listener.OnItemSwipeListener;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * more infomation see{@link  public void openLoadMore(int pageSize, boolean enable),@link  public void setOnLoadMoreListener(OnLoadMoreListener onLoadMoreListener)} method
     *
     * @param pageSize
     * @param onLoadMoreListener
     */
    @Deprecated
    public void setOnLoadMoreListener(int pageSize, OnLoadMoreListener onLoadMoreListener) {
    ...
    private boolean isLoadMore() {
        return mNextLoadEnable && pageSize != -1 && mOnLoadMoreListener != null && mData.size() >= pageSize;
    }
