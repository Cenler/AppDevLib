...
public class LazyViewPager extends ViewGroup {
    protected static final String TAG = "LazyViewPager";
    private static final boolean DEBUG = false;

    private static final boolean USE_CACHE = false;

    private static final int DEFAULT_OFFSCREEN_PAGES = 0;// 通过设置该值来屏蔽预加载模式（默认 = 1）
    ...
    /**
     * Simple implementation of the { android.support.v4.view.LazyViewPager.OnPageChangeListener} interface with stub
     * implementations of each method. Extend this if you do not intend to override
     * every method of { android.support.v4.view.LazyViewPager.OnPageChangeListener}.
     */
